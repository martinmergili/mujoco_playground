...
from mujoco_playground._src.locomotion.solo8.trotting_demonstration_trajectory import SOLO8_XML_DIR
...
class Solo8Env(mjx_env.MjxEnv):
  """Base class for Solo8 environments."""
